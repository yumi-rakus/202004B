...
class ItemRepositoryTest {
	...
	public void findAllTest() {
		...
		assertEquals("グリーンアスパラと相性の良いベーコンにいろどりのフレッシュトマトをトッピングし特製マヨソースでまとめた商品です", itemList.get(1).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("マイルドな味付けのカレーに大きくカットした味噌カツをのせた、バターとチーズの風味が食欲をそそるお子様でも楽しめる商品です", itemList.get(3).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("カレーはライスだけではありません。ラクラクピザが開発したカレーラーメンは絶品の美味しさ！", itemList.get(4).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("やわらかくあっさりとしたヒレ肉を上質な衣で包み込みました。4種類の濃厚な味わいが一つで楽しめるカレーです", itemList.get(5).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("こだわりのソースで、旨みとコクを堪能！濃厚Gorgeous4とは、動物由来の原材料を使用していないカレーです。ベジタリアンの方にオススメです", itemList.get(6).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("ラクラクカレー自慢のカレーに魚介のダシ、ローストオニオンのコクが加わった絶妙なスープをお楽しみください", itemList.get(7).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("にんにくとトマトの旨みが効いたスパイスカレー。食べると思わず元気が出るラクラクカレーの自信作", itemList.get(8).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("カレードリアの王道！ホワイトソースとカレーのダブルソースとなす、ほうれん草、チーズのおいしい組み合わせ", itemList.get(9).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("季節の野菜が一つになった4種の栄養満点カレー。ラクラクカレーオリジナル商品でベジタリアンの方にオススメです", itemList.get(11).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("あらびきスライス牛肉とイタリアンチーズを、トマトソースと特製マヨソースの2種類のソースで召し上がって頂く商品です", itemList.get(12).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("ラクラクピザ自慢「特うまプルコギ」定番「デラックス」お子様に人気「ツナマイルド」女性に好評「チーズ＆チーズ」の４種のおいしさを贅沢に組み合わせました", itemList.get(14).getDescription(), "説明が期待される結果と異なります。");
	...
	public void loadTest2() {
		...
		assertEquals("グリーンアスパラと相性の良いベーコンにいろどりのフレッシュトマトをトッピングし特製マヨソースでまとめた商品です", item.getDescription(), "説明が期待される結果と異なります。");
		assertEquals(1490, item.getPriceM(), "Mサイズ価格が期待される結果と異なります。");
		assertEquals(2570, item.getPriceL(), "Lサイズ価格が期待される結果と異なります。");
	...
	public void loadTest4() {
		...
		assertEquals("マイルドな味付けのカレーに大きくカットした味噌カツをのせた、バターとチーズの風味が食欲をそそるお子様でも楽しめる商品です", item.getDescription(), "説明が期待される結果と異なります。");
	...
	public void loadTest6() {
		...
		assertEquals("やわらかくあっさりとしたヒレ肉を上質な衣で包み込みました。4種類の濃厚な味わいが一つで楽しめるカレーです", item.getDescription(), "説明が期待される結果と異なります。");
	...
	public void loadTest7() {
		...
		assertEquals("こだわりのソースで、旨みとコクを堪能！濃厚Gorgeous4とは、動物由来の原材料を使用していないカレーです。ベジタリアンの方にオススメです", item.getDescription(), "説明が期待される結果と異なります。");
	...
	public void loadTest12() {
		...
		assertEquals("季節の野菜が一つになった4種の栄養満点カレー。ラクラクカレーオリジナル商品でベジタリアンの方にオススメです", item.getDescription(), "説明が期待される結果と異なります。");
		assertEquals(2160, item.getPriceM(), "Mサイズ価格が期待される結果と異なります。");
		assertEquals(3380, item.getPriceL(), "Lサイズ価格が期待される結果と異なります。");
	...
	public void loadTest13() {
		...
		assertEquals("あらびきスライス牛肉とイタリアンチーズを、トマトソースと特製マヨソースの2種類のソースで召し上がって頂く商品です", item.getDescription(), "説明が期待される結果と異なります。");
		assertEquals(2160, item.getPriceM(), "Mサイズ価格が期待される結果と異なります。");
		assertEquals(3380, item.getPriceL(), "Lサイズ価格が期待される結果と異なります。");
	...
	public void loadTest15() {
		...
		assertEquals("ラクラクピザ自慢「特うまプルコギ」定番「デラックス」お子様に人気「ツナマイルド」女性に好評「チーズ＆チーズ」の４種のおいしさを贅沢に組み合わせました", item.getDescription(), "説明が期待される結果と異なります。");
	...
	public void updateDeleteFlagAndfindAllByPriceTest1() {
		...
		List<Item> itemList = itemRepository.findAllByPrice();
		...
		assertEquals("グリーンアスパラと相性の良いベーコンにいろどりのフレッシュトマトをトッピングし特製マヨソースでまとめた商品です", itemList.get(0).getDescription(), "説明が期待される結果と異なります。");
		assertEquals(1490, itemList.get(0).getPriceM(), "Mサイズ価格が期待される結果と異なります。");
		assertEquals(2570, itemList.get(0).getPriceL(), "Lサイズ価格が期待される結果と異なります。");
		...
		assertEquals("カレーはライスだけではありません。ラクラクピザが開発したカレーラーメンは絶品の美味しさ！", itemList.get(1).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("あらびきスライス牛肉とイタリアンチーズを、トマトソースと特製マヨソースの2種類のソースで召し上がって頂く商品です", itemList.get(2).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("カレードリアの王道！ホワイトソースとカレーのダブルソースとなす、ほうれん草、チーズのおいしい組み合わせ", itemList.get(3).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("季節の野菜が一つになった4種の栄養満点カレー。ラクラクカレーオリジナル商品でベジタリアンの方にオススメです", itemList.get(4).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("ラクラクピザ自慢「特うまプルコギ」定番「デラックス」お子様に人気「ツナマイルド」女性に好評「チーズ＆チーズ」の４種のおいしさを贅沢に組み合わせました", itemList.get(5).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("こだわりのソースで、旨みとコクを堪能！濃厚Gorgeous4とは、動物由来の原材料を使用していないカレーです。ベジタリアンの方にオススメです", itemList.get(7).getDescription(), "説明が期待される結果と異なります。");
		...
		assertEquals("やわらかくあっさりとしたヒレ肉を上質な衣で包み込みました。4種類の濃厚な味わいが一つで楽しめるカレーです", itemList.get(11).getDescription(), "説明が期待される結果と異なります。");
