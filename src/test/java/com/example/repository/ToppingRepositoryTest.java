...
class ToppingRepositoryTest {
	...
	public void findAllTest() {
		...
		assertEquals(1, toppingList.get(0).getId(), "IDが期待される結果と異なります。");
		assertEquals("オニオン", toppingList.get(0).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(2, toppingList.get(1).getId(), "IDが期待される結果と異なります。");
		assertEquals("ツナマヨ", toppingList.get(1).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(3, toppingList.get(2).getId(), "IDが期待される結果と異なります。");
		assertEquals("イタリアントマト", toppingList.get(2).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(4, toppingList.get(3).getId(), "IDが期待される結果と異なります。");
		assertEquals("イカ", toppingList.get(3).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(5, toppingList.get(4).getId(), "IDが期待される結果と異なります。");
		assertEquals("プルコギ", toppingList.get(4).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(6, toppingList.get(5).getId(), "IDが期待される結果と異なります。");
		assertEquals("アンチョビ", toppingList.get(5).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(7, toppingList.get(6).getId(), "IDが期待される結果と異なります。");
		assertEquals("エビ", toppingList.get(6).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(8, toppingList.get(7).getId(), "IDが期待される結果と異なります。");
		assertEquals("コーン", toppingList.get(7).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(9, toppingList.get(8).getId(), "IDが期待される結果と異なります。");
		assertEquals("ピーマン", toppingList.get(8).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(10, toppingList.get(9).getId(), "IDが期待される結果と異なります。");
		assertEquals("フレッシュスライストマト", toppingList.get(9).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(11, toppingList.get(10).getId(), "IDが期待される結果と異なります。");
		assertEquals("ベーコン", toppingList.get(10).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(12, toppingList.get(11).getId(), "IDが期待される結果と異なります。");
		assertEquals("ペパロニ･サラミ", toppingList.get(11).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(13, toppingList.get(12).getId(), "IDが期待される結果と異なります。");
		assertEquals("熟成ベーコン", toppingList.get(12).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(14, toppingList.get(13).getId(), "IDが期待される結果と異なります。");
		assertEquals("特製マヨソース", toppingList.get(13).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(15, toppingList.get(14).getId(), "IDが期待される結果と異なります。");
		assertEquals("カマンベールチーズ", toppingList.get(14).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(16, toppingList.get(15).getId(), "IDが期待される結果と異なります。");
		assertEquals("フレッシュモッツァレラチーズ", toppingList.get(15).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(17, toppingList.get(16).getId(), "IDが期待される結果と異なります。");
		assertEquals("イタリアンソーセージ", toppingList.get(16).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(18, toppingList.get(17).getId(), "IDが期待される結果と異なります。");
		assertEquals("ガーリックスライス", toppingList.get(17).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(19, toppingList.get(18).getId(), "IDが期待される結果と異なります。");
		assertEquals("あらびきスライスソｰセｰジ", toppingList.get(18).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(20, toppingList.get(19).getId(), "IDが期待される結果と異なります。");
		assertEquals("ブロッコリー", toppingList.get(19).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(21, toppingList.get(20).getId(), "IDが期待される結果と異なります。");
		assertEquals("グリーンアスパラ", toppingList.get(20).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(22, toppingList.get(21).getId(), "IDが期待される結果と異なります。");
		assertEquals("パルメザンチーズ", toppingList.get(21).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(23, toppingList.get(22).getId(), "IDが期待される結果と異なります。");
		assertEquals("パイナップル", toppingList.get(22).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(24, toppingList.get(23).getId(), "IDが期待される結果と異なります。");
		assertEquals("ハラペーニョ", toppingList.get(23).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(25, toppingList.get(24).getId(), "IDが期待される結果と異なります。");
		assertEquals("もち", toppingList.get(24).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(26, toppingList.get(25).getId(), "IDが期待される結果と異なります。");
		assertEquals("ポテト", toppingList.get(25).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(27, toppingList.get(26).getId(), "IDが期待される結果と異なります。");
		assertEquals("ブラックオリーブ", toppingList.get(26).getName(), "名前が期待される結果と異なります。");
		...
		assertEquals(28, toppingList.get(27).getId(), "IDが期待される結果と異なります。");
		assertEquals("チーズ増量", toppingList.get(27).getName(), "名前が期待される結果と異なります。");
