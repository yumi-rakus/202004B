...
class OrderToppingServiceTest {
	...
	public void 事前処理() {
		...
		orderToppingService.insertOrderTopping(orderTopping1of1);
		orderToppingService.insertOrderTopping(orderTopping2of1);
		orderToppingService.insertOrderTopping(orderTopping3of1);
		...
		orderToppingService.insertOrderTopping(orderTopping1of2);
		orderToppingService.insertOrderTopping(orderTopping2of2);
		...
		orderToppingService.insertOrderTopping(orderTopping1of3);
		orderToppingService.insertOrderTopping(orderTopping2of3);
		orderToppingService.insertOrderTopping(orderTopping3of3);
		orderToppingService.insertOrderTopping(orderTopping4of3);
	}
	...
	public void getToppingIdListByOrderItemIdTest2() {
		...
		List<Integer> toppingIdList = orderToppingService.getToppingIdListByOrderItemId(2);
	...
	public void getToppingIdListByOrderItemIdTest3() {
		...
		List<Integer> toppingIdList = orderToppingService.getToppingIdListByOrderItemId(3);
