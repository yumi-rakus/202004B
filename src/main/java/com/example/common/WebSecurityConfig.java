...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  @Override
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
		.authorizeRequests()
			.antMatchers("/toLogin", "/insertUser", "/", "/search","/showDetail", "/order", "/indexRegister", "/register", "/showCartList", "/deleteOrderItem", "/cartIn", "/cartInComplete", "/ajax/**", "/deleteAll").permitAll()
